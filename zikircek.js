...
window.addEventListener('popstate', function (event) {
    bildirimOlustur("Bilgilendirme", "Muhterem kullanıcılarımız zikir çekerken yanlışlıkla sekmeyi kapattığından dolayı geri tuşu devre dışı bırakılmıştır.", 5000);
    history.pushState(null, document.title, location.href);
});
